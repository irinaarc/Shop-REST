...
import com.arcirina.catalogue.controller.payload.UpdateProductPayload;
...
public class ProductRestController {
    ...
    @PatchMapping
    public ResponseEntity<ProblemDetail> updateProduct(@PathVariable("productId") int productId,
